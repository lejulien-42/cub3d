...
/*   Updated: 2020/03/05 05:58:02 by lejulien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ptr == NULL)
		ft_puterror("Error wrong file\n");
}

static void
	ft_load_normalsprite2(t_mlx_data *data)
{
	ft_a(data->s_escalier.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		"./textures/hadhio.xpm", &data->s_escalier.width,
		&data->s_escalier.height));
	ft_a(data->s_fl.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		"./textures/spookyfl.xpm", &data->s_fl.width, &data->s_fl.height));
	ft_a(data->s_floorfour.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		"./textures/FLOOR_04.xpm", &data->s_floorfour.width,
		&data->s_floorfour.height));
	ft_a(data->s_roofeleven.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		"./textures/ROOF_11.xpm", &data->s_roofeleven.width,
		&data->s_roofeleven.height));
	ft_a(data->s_arrowtex.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		"./textures/right.xpm", &data->s_arrowtex.width,
		&data->s_arrowtex.height));
	ft_a(data->s_arrowtexl.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		"./textures/left.xpm", &data->s_arrowtexl.width,
		&data->s_arrowtexl.height));
	ft_a(data->s_lifeframe.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
...
{
	ft_a(data->img.img_ptr = mlx_new_image(data->data->mlx_win,
		data->sort->resw, data->sort->resh));
	ft_a(data->s_walltwo.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		ft_testsrc(data->sort->northpath), &data->s_walltwo.width,
		&data->s_walltwo.height));
	ft_a(data->s_wallfour.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		ft_testsrc(data->sort->southpath), &data->s_wallfour.width,
		&data->s_wallfour.height));
	ft_a(data->s_lava.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		ft_testsrc(data->sort->eastpath), &data->s_lava.width,
		&data->s_lava.height));
	ft_a(data->s_health.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		ft_testsrc(data->sort->westpath), &data->s_health.width,
		&data->s_health.height));
	ft_a(data->s_monster.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		ft_testsrc(data->sort->sprite), &data->s_monster.width,
		&data->s_monster.height));
	ft_a(data->s_wall.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
		"./textures/WALL_01.xpm", &data->s_wall.width, &data->s_wall.height));
	ft_a(data->s_wallthree.img_ptr = mlx_xpm_file_to_image(data->data->mlx_ptr,
